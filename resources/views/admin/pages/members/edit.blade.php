    ...
    <div class="page-content">
        <div class="widget">
            ...
            <div class="widget-content">
                <form method="put" action="{{ route('admin.members.update', ['id' => $member->id]) }}"
                    class="ajax-form">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-6">
                            <img src="{{ get_image($member->image, 'members') }}" style="height : 100px !important">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_en"
                                    value="{{ $member->translate('en')->name }}" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ar"
                                    value="{{ $member->translate('ar')->name }}" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="position_en"
                                    value="{{ $member->translate('en')->position }}" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="position_ar"
                                    value="{{ $member->translate('ar')->position }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
